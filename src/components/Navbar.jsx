      ...
      <nav className="bg-white border-b px-6 py-4">
        <div className='container mx-auto flex justify-between items-center'>
          ...
          <div className="flex gap-6 items-center">
            ...
            <a href=""> <button type='button' onClick={(e) => {
              e.preventDefault();
              onAddMember();
            }} className='bg-indigo-500 text-white px-4 py-2 rounded-md hover:bg-indigo-700 transition-colors PlusCircle hover:cursor-pointer'> Add Member </button></a>
          </div>
        </div>
      </nav>
    </>
